        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#myworks" className="text-gray-400 hover:text-white transition-colors">My Works</a></li>
              <li><a href="#aboutme" className="text-gray-400 hover:text-white transition-colors">About Me</a></li>
              <li><a href="#experience" className="text-gray-400 hover:text-white transition-colors">Skills</a></li>
